...
export function CheckoutHeader() {
  return (
    <header className="border-b border-line bg-raised">
      <div className="mx-auto flex h-18 max-w-[1100px] items-center justify-between gap-4 px-5 md:px-10">
        ...
        <div className="flex items-center gap-4">
          <span className="hidden items-center gap-1.5 font-mono text-[0.68rem] text-ink-dim sm:flex">
            <LockKeyhole className="size-3" /> checkout (not actually secure, nothing to secure)
          </span>
          <ThemeToggle />
        </div>
      </div>
